      ...
      <aside className="Aside-Section">
        <div>
          <h1 className="Aside-Heading">
            ...
            <p className="Aside-Heading-Text">Dashboard<span className="Aside-Heading-Version">v.01</span></p>  
          </h1>
          <nav className="Aside-Navbar">
            <a className="Aside-Navbar-Link" href="#">
              <div className="Aside-Navbar-Link-Container">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M16.28 13.61C15.15 14.74 13.53 15.09 12.1 14.64L9.51001 17.22C9.33001 17.41 8.96001 17.53 8.69001 17.49L7.49001 17.33C7.09001 17.28 6.73001 16.9 6.67001 16.51L6.51001 15.31C6.47001 15.05 6.60001 14.68 6.78001 14.49L9.36001 11.91C8.92001 10.48 9.26001 8.86001 10.39 7.73001C12.01 6.11001 14.65 6.11001 16.28 7.73001C17.9 9.34001 17.9 11.98 16.28 13.61Z" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M10.45 16.28L9.59998 15.42" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M13.3945 10.7H13.4035" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <p>Dashboard</p>
              </div>
            </a>
            ...
            <a className="Aside-Navbar-Link" href="#">
              <div className="Aside-Navbar-Link-Container"> 
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.7516 16.8604V18.8904C10.7516 20.6104 9.15158 22.0004 7.18158 22.0004C5.21158 22.0004 3.60156 20.6104 3.60156 18.8904V16.8604C3.60156 18.5804 5.20158 19.8004 7.18158 19.8004C9.15158 19.8004 10.7516 18.5704 10.7516 16.8604Z" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M10.7501 14.11C10.7501 14.61 10.6101 15.07 10.3701 15.47C9.78006 16.44 8.57004 17.05 7.17004 17.05C5.77004 17.05 4.56003 16.43 3.97003 15.47C3.73003 15.07 3.59009 14.61 3.59009 14.11C3.59009 13.25 3.99007 12.48 4.63007 11.92C5.28007 11.35 6.17003 11.01 7.16003 11.01C8.15003 11.01 9.04006 11.36 9.69006 11.92C10.3501 12.47 10.7501 13.25 10.7501 14.11Z" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M10.7516 14.11V16.86C10.7516 18.58 9.15158 19.8 7.18158 19.8C5.21158 19.8 3.60156 18.57 3.60156 16.86V14.11C3.60156 12.39 5.20158 11 7.18158 11C8.17158 11 9.06161 11.35 9.71161 11.91C10.3516 12.47 10.7516 13.25 10.7516 14.11Z" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M22 10.9699V13.03C22 13.58 21.56 14.0299 21 14.0499H19.0399C17.9599 14.0499 16.97 13.2599 16.88 12.1799C16.82 11.5499 17.0599 10.9599 17.4799 10.5499C17.8499 10.1699 18.36 9.94995 18.92 9.94995H21C21.56 9.96995 22 10.4199 22 10.9699Z" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M2 10.5V8.5C2 5.78 3.64 3.88 6.19 3.56C6.45 3.52 6.72 3.5 7 3.5H16C16.26 3.5 16.51 3.50999 16.75 3.54999C19.33 3.84999 21 5.76 21 8.5V9.95001H18.92C18.36 9.95001 17.85 10.17 17.48 10.55C17.06 10.96 16.82 11.55 16.88 12.18C16.97 13.26 17.96 14.05 19.04 14.05H21V15.5C21 18.5 19 20.5 16 20.5H13.5" className="Navbar-Icon-Arrow-Part" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <p>Income</p>
              </div>
              <svg className="Navbar-Arrow" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a className="Aside-Navbar-Link" href="#">
              <div className="Aside-Navbar-Link-Container">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 22.3199C7.72 22.3199 7.42998 22.2499 7.16998 22.1099C6.59998 21.8099 6.25 21.2099 6.25 20.5699V19.15C3.23 18.84 1.25 16.6199 1.25 13.4399V7.43994C1.25 3.99994 3.56 1.68994 7 1.68994H17C20.44 1.68994 22.75 3.99994 22.75 7.43994V13.4399C22.75 16.8799 20.44 19.1899 17 19.1899H13.23L8.96997 22.03C8.67997 22.22 8.34 22.3199 8 22.3199ZM7 3.17993C4.42 3.17993 2.75 4.84993 2.75 7.42993V13.43C2.75 16.01 4.42 17.68 7 17.68C7.41 17.68 7.75 18.02 7.75 18.43V20.56C7.75 20.69 7.83 20.75 7.88 20.78C7.93001 20.81 8.03001 20.84 8.14001 20.77L12.59 17.81C12.71 17.73 12.86 17.68 13.01 17.68H17.01C19.59 17.68 21.26 16.01 21.26 13.43V7.42993C21.26 4.84993 19.59 3.17993 17.01 3.17993H7Z" className="Navbar-Icon-Part"  fill="#9197B3"/>
                  <path d="M11.9998 12.1099C11.5898 12.1099 11.2498 11.7699 11.2498 11.3599V11.1499C11.2498 9.9899 12.0998 9.41989 12.4198 9.19989C12.7898 8.94989 12.9098 8.7799 12.9098 8.5199C12.9098 8.0199 12.4998 7.60986 11.9998 7.60986C11.4998 7.60986 11.0898 8.0199 11.0898 8.5199C11.0898 8.9299 10.7498 9.2699 10.3398 9.2699C9.92984 9.2699 9.58984 8.9299 9.58984 8.5199C9.58984 7.1899 10.6698 6.10986 11.9998 6.10986C13.3298 6.10986 14.4098 7.1899 14.4098 8.5199C14.4098 9.6599 13.5698 10.2299 13.2598 10.4399C12.8698 10.6999 12.7498 10.8699 12.7498 11.1499V11.3599C12.7498 11.7799 12.4098 12.1099 11.9998 12.1099Z" className="Navbar-Icon-Part"  fill="#9197B3"/>
                  <path d="M12 14.6001C11.58 14.6001 11.25 14.2601 11.25 13.8501C11.25 13.4401 11.59 13.1001 12 13.1001C12.41 13.1001 12.75 13.4401 12.75 13.8501C12.75 14.2601 12.42 14.6001 12 14.6001Z" className="Navbar-Icon-Part"  fill="#9197B3"/>
                </svg>
                <p>Help</p>
              </div>
              <svg className="Navbar-Arrow" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="Aside-User-Box">
          <img className="User-Box-Picture" alt="User" src={require("./data/Ellipse.png")}></img>
          <div className="Aside-User-Box-Inner-Container">
            <p className="User-Name">Evano</p>
            <p className="User-Description">Project Manager</p>
          </div>
        </div>
      </aside>
      <section className="Main-Section">
        <p className="Main-Section-Heading">Hello Evano 👋🏼,</p>
        <div className="Main-Section-Table">
          <div className="Table-Top-Section">
            <div className="Table-Top-Section-Extra-Container">
              <p className="Table-Top-Section-Heading">All Customers</p>
              <p className="Table-Top-Section-Extra-Heading">Active Members</p>
            </div>
            <div className="Table-Top-Section-Search-Bar">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input placeholder="Search" className="Search-Bar-Placeholder"></input>
            </div>
          </div>
            ...
            <table className="Table">
              <thead>
                <tr className="Table-Headings">
                  <th className="Table-Heading-Cells">Customer Name</th>
                  <th>Company</th>
                  <th>Phone Number</th>
                  <th>Email</th>
                  <th>Country</th>
              ...
              {customersData.map((item) => 
                <tr key={customersData.indexOf(item)}>
                  <td>{item.name}</td>
                  <td>{item.company}</td>
                  ...
                  {
                    item.status === "Active" ?
                    <td className="Status-Cell"><span className="Marked-Table-Cell Active-Table-Cell">{item.status}</span></td>
                    : <td className="Status-Cell"><p className="Marked-Table-Cell Unactive-Table-Cell">{item.status}</p></td>
                  }
          ...
          <div className="Table-Bottom-Section">
              <p className="Table-Bottom-Info">Showing data 1 to 8 of 256K entries</p>
              <div className="Table-Bottom-Button-Group">
                <button className="Table-Bottom-Button">{`<`}</button>
                <button className="Table-Bottom-Button Current-Active-Button">1</button>
                <button className="Table-Bottom-Button">2</button>
                <button className="Table-Bottom-Button">3</button>
                <button className="Table-Bottom-Button">4</button>
                <button className="Table-Bottom-Button Show-More-Button">...</button>
                <button className="Table-Bottom-Button">40</button>
                <button className="Table-Bottom-Button">{`>`}</button>
              </div>
          </div>
        </div>
